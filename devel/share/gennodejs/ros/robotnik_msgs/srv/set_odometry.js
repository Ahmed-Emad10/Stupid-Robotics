...
class set_odometryRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new set_odometryRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new set_odometryRequest(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
class set_odometryResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new set_odometryResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new set_odometryResponse(null);
...
module.exports = {
  ...
  md5sum() { return '34ddd7aa1617c391983fb2ede12712ee'; },
  datatype() { return 'robotnik_msgs/set_odometry'; }
};
