...
class set_heightRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new set_heightRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new set_heightRequest(null);
...
class set_heightResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new set_heightResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new set_heightResponse(null);
...
module.exports = {
  ...
  md5sum() { return '30c54779fb893ca6d32239f321774b5f'; },
  datatype() { return 'robotnik_msgs/set_height'; }
};
