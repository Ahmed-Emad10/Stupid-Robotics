...
"""autogenerated by genpy from robotnik_msgs/encoders.msg. Do not edit."""
import codecs
import sys
...
class encoders(genpy.Message):
  _md5sum = "b5def35e667417de284b17ffe2083938"
  _type = "robotnik_msgs/encoders"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# 0-> right incremental, 1-> left incremental, 2-> steer absolute
string[] type
int32[] counts
int32[] vel
"""
  __slots__ = ['type','counts','vel']
