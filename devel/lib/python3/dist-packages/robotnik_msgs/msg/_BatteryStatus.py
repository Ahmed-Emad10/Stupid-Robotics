...
class BatteryStatus(genpy.Message):
  _md5sum = "8730315e1ea11d6ba3e264e6efe816c2"
...
"""
  __slots__ = ['voltage','current','level','time_remaining','time_charging','is_charging','cell_voltages']
  _slot_types = ['float32','float32','float32','uint32','uint32','bool','float32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       voltage,current,level,time_remaining,time_charging,is_charging,cell_voltages
