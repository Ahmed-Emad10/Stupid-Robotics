...
class SetElevatorActionFeedback(genpy.Message):
  _md5sum = "d977e6a7039669a4be1509f51814113f"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.status.height
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.status.state = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.feedback.status.position = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.feedback.status.position = str[start:end]
      start = end
      end += 4
      (self.feedback.status.height,) = _get_struct_f().unpack(str[start:end])
      return self
